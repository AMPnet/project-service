...
==== List all members
.Request
include::{snippets}/OrganizationMemberControllerTest/mustBeAbleToGetOrganizationMembers/http-request.adoc[]
.Response
include::{snippets}/OrganizationMemberControllerTest/mustBeAbleToGetOrganizationMembers/http-response.adoc[]

==== Delete a member
.Request
include::{snippets}/OrganizationMemberControllerTest/mustBeAbleToDeleteOrganizationMember/http-request.adoc[]
.Response
include::{snippets}/OrganizationMemberControllerTest/mustBeAbleToDeleteOrganizationMember/http-response.adoc[]

==== Update organization role
.Request
include::{snippets}/OrganizationMemberControllerTest/mustBeAbleToChangeUserOrganizationRole/http-request.adoc[]
.Response
include::{snippets}/OrganizationMemberControllerTest/mustBeAbleToChangeUserOrganizationRole/http-response.adoc[]
...
=== Get project
.Request
include::{snippets}/PublicProjectControllerTest/mustBeAbleToGetSpecificProject/http-request.adoc[]
.Response
include::{snippets}/PublicProjectControllerTest/mustBeAbleToGetSpecificProject/http-response.adoc[]
