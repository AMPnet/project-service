...
List can be sorted using param: `sort` (e.g. `sort=name,asc`).
...
==== Set project tags
Set full list of tags for project. Provided list of tags will overwrite old list of tags.

.Request
include::{snippets}/ProjectControllerTest/mustBeAbleToAddProjectTags/http-request.adoc[]
.Response
include::{snippets}/ProjectControllerTest/mustBeAbleToAddProjectTags/http-response.adoc[]

==== Get all project tags
.Request
include::{snippets}/ProjectControllerTest/mustBeAbleToGetAllProjectTags/http-request.adoc[]
.Response
include::{snippets}/ProjectControllerTest/mustBeAbleToGetAllProjectTags/http-response.adoc[]
...
.Request
include::{snippets}/ProjectControllerTest/mustBeAbleToQueryProjectsByTags/http-request.adoc[]
.Response
include::{snippets}/ProjectControllerTest/mustBeAbleToQueryProjectsByTags/http-response.adoc[]

=== Update
All values are optional. Only provided values will be updated. For list values: `tags`, old values are overwritten
by a new list.
