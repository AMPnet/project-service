...
=== Get project
.Request
include::{snippets}/PublicProjectControllerTest/mustBeAbleToGetSpecificProjectWithWallet/http-request.adoc[]
.Response
include::{snippets}/PublicProjectControllerTest/mustBeAbleToGetSpecificProjectWithWallet/http-response.adoc[]
