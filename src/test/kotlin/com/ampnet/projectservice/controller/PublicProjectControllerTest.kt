...
class PublicProjectControllerTest : ControllerTestBase() {
    ...
    fun mustBeAbleToGetSpecificProjectWithWalletAndOrganization() {
        ...
        verify("Project response is valid") {
            ...
            verifyImageResponse(testContext.project.mainImage, projectResponse.image)
    ...
    fun mustBeAbleToGetActiveProjects() {
        ...
        verify("Controller will return active projects with active wallets") {
            ...
            assertThat(projectWithWallet.project.location).isEqualTo(testContext.project.location?.let { ProjectLocationResponse(it) })
            assertThat(projectWithWallet.project.roi).isEqualTo(testContext.project.roi?.let { ProjectRoiResponse(it) })
            ...
            verifyImageResponse(testContext.project.mainImage, projectWithWallet.project.image)
