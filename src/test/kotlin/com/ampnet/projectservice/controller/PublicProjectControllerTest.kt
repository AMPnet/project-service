...
class PublicProjectControllerTest : ControllerTestBase() {
    ...
    fun mustBeAbleToGetSpecificProjectWithWallet() {
        ...
        verify("Project response is valid") {
            ...
            assertThat(projectResponse.project.uuid).isEqualTo(testContext.project.uuid)
            assertThat(projectResponse.project.name).isEqualTo(testContext.project.name)
            assertThat(projectResponse.project.description).isEqualTo(testContext.project.description)
            assertThat(projectResponse.project.location.lat).isEqualTo(testContext.project.location.lat)
            assertThat(projectResponse.project.location.long).isEqualTo(testContext.project.location.long)
            assertThat(projectResponse.project.roi.from).isEqualTo(testContext.project.roi.from)
            assertThat(projectResponse.project.roi.to).isEqualTo(testContext.project.roi.to)
            assertThat(projectResponse.project.startDate).isEqualTo(testContext.project.startDate)
            assertThat(projectResponse.project.endDate).isEqualTo(testContext.project.endDate)
            assertThat(projectResponse.project.expectedFunding).isEqualTo(testContext.project.expectedFunding)
            assertThat(projectResponse.project.currency).isEqualTo(testContext.project.currency)
            assertThat(projectResponse.project.minPerUser).isEqualTo(testContext.project.minPerUser)
            assertThat(projectResponse.project.maxPerUser).isEqualTo(testContext.project.maxPerUser)
            assertThat(projectResponse.project.mainImage).isEqualTo(testContext.project.mainImage)
            assertThat(projectResponse.project.gallery).isEqualTo(testContext.project.gallery.orEmpty())
            assertThat(projectResponse.project.news).isEqualTo(testContext.project.newsLinks.orEmpty())
